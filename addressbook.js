...
try {
    ...
    detailsArray.push(new Contact('Gagan', 'Reddy', 'Heelalige', 'Bangaluru', 'KA', '560099',
        '91 8052696969', 'gagan@gmail.com'));
    detailsArray.push(new Contact('Shravya', 'Reddy', 'Santhapuram', 'Hosur', 'TN', '652123',
        '91 9452696969', 'shravya@gmail.com'));

    console.log('contacts before being updated \n');
    detailsArray.forEach((contact) => console.log(contact.toString()));
    detailsArray.filter(contact => contact.firstName == 'Gagan').map(contact => contact.firstName = "Bahubali");
